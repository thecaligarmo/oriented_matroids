...
class SignedSubsetElement(Element):
    ...
    def __call__(self, var):
        ...
        - ``var`` -- the element to check sign of.
    ...
    def __eq__(self, other):
        ...
        - ``other`` -- A :class:`SignedSubsetElement` to test against `self`.
    ...
    def reorientation(self, change_set):
        ...
        - ``change_set`` -- A subset of the ground set to reorient over.
