...
class OrientedMatroids(Category):
    ...
    class ParentMethods:
        ...
        def deletion(self, change_set):
            ...
            `M\backslash A = (E \backslash A, \mathcal{C} \backslash A)` where
            ...
            groundset = deep_tupler(
                set(self.groundset()).difference(change_set))
            data = []
        ...
        def restriction(self, change_set):
            ...
            the oriented matroid `M / A = (E \backslash A, \mathcal{C} / A)`
            where
